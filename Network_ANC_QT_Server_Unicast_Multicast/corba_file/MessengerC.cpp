  ...
  const ::LocalInterface::CompositeTypes::cmdUpdateParametersCompType & cmdUpdateParametersParam)
{
  ...
  TAO::Arg_Traits< ::LocalInterface::CompositeTypes::cmdUpdateParametersCompType>::in_arg_val _tao_cmdUpdateParametersParam (cmdUpdateParametersParam);
...
void
Messenger::cmdUpdateParametersNew (
  const ::LocalInterface::CompositeTypes::cmdUpdateParametersCompTypeNew & cmdUpdateParametersParamNew)
{
  ...
  TAO::Arg_Traits< void>::ret_val _tao_retval;
  TAO::Arg_Traits< ::LocalInterface::CompositeTypes::cmdUpdateParametersCompTypeNew>::in_arg_val _tao_cmdUpdateParametersParamNew (cmdUpdateParametersParamNew);
...
void
Messenger::cmdUpdateParametersLogic (
  ...
  ::CORBA::Boolean ami_return_val)
{
  ...
  if (this->the_TAO_AMI_MessengerHandler_Proxy_Broker_ == 0)
    {
      AMI_MessengerHandler_setup_collocation ();
    }
  ...
  TAO::Invocation_Adapter _tao_call (
      ...
      "send_message",
      12,
      this->the_TAO_AMI_MessengerHandler_Proxy_Broker_
    );
...
AMI_MessengerHandler::AMI_MessengerHandler (void)
 : the_TAO_AMI_MessengerHandler_Proxy_Broker_ (0)
{
  this->AMI_MessengerHandler_setup_collocation ();
}

void
AMI_MessengerHandler::AMI_MessengerHandler_setup_collocation ()
{
  if (::_TAO_AMI_MessengerHandler_Proxy_Broker_Factory_function_pointer)
    {
      this->the_TAO_AMI_MessengerHandler_Proxy_Broker_ =
        ::_TAO_AMI_MessengerHandler_Proxy_Broker_Factory_function_pointer (this);
    }
...
namespace TAO
{
  template<>
  ::CORBA::Boolean
  Any_Dual_Impl_T<MessengerUnableToSendMessage>::demarshal_value (
      TAO_InputCDR & cdr
    )
  {
    ::CORBA::String_var id;
